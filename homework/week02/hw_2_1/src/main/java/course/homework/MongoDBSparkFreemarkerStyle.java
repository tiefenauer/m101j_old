...
/**
 * Homework 2.1: Class was downloaded as course material and can be run using maven using
 * <code>mvn compile exec:java -Dexec.mainClass=course.homework.MongoDBSparkFreemarkerStyle</code>
 * Navigating to http://localhost:4567/ will then give the answer!
 */
